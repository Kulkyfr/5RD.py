...
playerConstitution = 0
bridgeChoice = input("""You walk past many trees to find a bridge. But run into a big troll who stops you ate the bridge. He tells you,
"Hey! You! What are you doing in these parts! Where is your dabloon for entree to our land!!

You may either
A) Turn around and never come back,
or
B) Search these pecuiar looking bushes to the left: """)
bridgeChance = (random.randint(1, 20) + playerConstitution)
if bridgeChoice == "B":
  print(bridgeChance)
      if bridgeChance >= 5:
            print("You found a dabloon! Go use that for the troll!")
      elif bridgeChance < 5:
            print("You did not find a dabloon. The troll finishes you.")
            bridgeChoice = False
      else:
            print("How did you get this message? Die!")



#room1 = True
#room1Choice = input("""You find yourself at the entrance of a old and ransacked cavern. Tell me", playerName, "What will you do?"
#A) Enter the cave                           B)Turn back and never let the curiosity
#and see what lies within.:                  get the better of you.

#(Type 'A' or 'B')
#""")
#if room1Choice == "a" or "A":
#    while room1: print("You")
